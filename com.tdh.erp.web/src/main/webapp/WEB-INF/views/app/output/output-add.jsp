...
<form class="layui-form layui-form-pane" action="" lay-filter="example">
	...
	<div class="layui-inline">
		...
		<div class="layui-input-inline">
			<input type="text" name="output_date" id="output_date" lay-verify="output_date" placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input">
		</div>
	</div>
	</div>
		<div class="layui-form-item">
		...
		<div class="layui-input-inline">
			<input type="number" name="output_num" placeholder="0"  class="layui-input">
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-inline">
			<input type="number" name="output_price" placeholder="0"  class="layui-input">
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block" id="nature">
			<input type="checkbox" name="clickFarming" title="刷单">
			<input type="checkbox" name="gift" title="赠品">
		</div>
	</div>
	<div class="layui-form-item">
		<label class="layui-form-label">签收人信息</label>
		<div class="layui-input-inline">
