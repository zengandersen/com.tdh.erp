...
<head>
    <meta charset="utf-8">
    <title>进销存平台</title>
    <meta name="keywords" content="进销存平台">
    <meta name="description" content="进销存平台">
...
<script>
    layui.use(['jquery', 'layer', 'miniAdmin','miniTongji'], function () {
        ...
        var options = {
            iniUrl: "/generate-directory.do",    // 初始化接口
        ...
        $('.login-out').on("click", function () {
            layer.msg('正在退出，请稍候...', {icon: 16, time: 2000, shade: 0}, function () {
