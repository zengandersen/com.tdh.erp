                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <button type="button" name="btnAdd" class="layui-btn layui-btn-normal" data-type="add"><i
                                    class="layui-icon layui-icon-ok-circle"></i>新增商品
                            </button>
                        </div>
                    </div>
                </form>
    ...
    var active = {
        getInfo: function () {
            ...
            var index = layer.open({
                type: 2,
                title: "新增",
                content: '/to-goods-add.do',
                maxmin: true,
                success: function (layer, index) {
                    var iframe = window['layui-layer-iframe' + index];
                    iframe.child("",factory_enum,unit_enum)
                }
            });
            layer.full(index);
        }, save: function () {
        ...
        switch (event) {
            ...
            case "edit":
                var index = layer.open({
                    type: 2,
                    title: "修改",
                    content: '/to-goods-detail.do',
                    maxmin: true,
                    success: function (layer, index) {
                        var iframe = window['layui-layer-iframe' + index];
                        iframe.child(data,factory_enum,unit_enum)
                    }
                });
                layer.full(index);
                break;
