...
<form class="layui-form layui-form-pane" action="" lay-filter="example">
	<input type="text" name="repertory_id"  style="display: none">
...
<script type="text/javascript">
	var pathUrl ;
	var goods_enum;
    function child(data,factory_enum,goods_enum,goods_img) {
            $.ajax({
                url: '/query-repertory-detail.do',
                type: 'POST',
                async: false,
                data: {"detail_id":data.repertory_id}
            })
                .done(function (message) {
                    ...
                    if (json.code == "success") {
                        if(json.data != "create"){
                            ...
                            $("#uploadComplate_info").attr('src',goods_img.goods_img);
                            form.val('example', {
                                "repertory_id":json.data.repertory_id,
                                "factory_id": json.data.factory_id,
                                "goods_id": json.data.goods_id,
                                "goods_name":  json.data.goods_name,
								"total": json.data.total,
								"warning_num":json.data.warning_num,
                                "remark":""
                            })
                            form.render();
						}
